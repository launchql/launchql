...
export const getGISTypeDetails = (modifier: number): GisTypeDetails => {
  ...
  const subtype = subtypeNumeric as GisSubtype;
...
export const getGISTypeModifier = (subtype: GisSubtype, hasZ: boolean, hasM: boolean, srid: number): number => {
  // Ref: https://github.com/postgis/postgis/blob/2.5.2/liblwgeom/liblwgeom.h.in#L156-L173
...
export const getGISTypeName = (subtype: GisSubtype, hasZ: boolean, hasM: boolean): string => {
